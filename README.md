...
- (Windows) Build tools for native modules may be needed to install `bcrypt` (e.g. Visual Studio Build Tools / Python). On other OSes ensure build toolchain is available.
